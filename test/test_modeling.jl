...
co2 = WellMixedGas("HITRAN/CO2.par", 400e-6, ν, Ω, PHCO2!, progress=false)
ch4 = WellMixedGas("HITRAN/CH4.par", 1e-5, ν, Ω, lorentz!, progress=false)
h2o = VariableGas("HITRAN/H2O.par", (T,P)->0.01, ν, Ω, voigt!, progress=false)
...
h2o = reconcentrate(h2o, Γ, T->0.8*psatH2O(T))
